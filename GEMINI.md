...
2.  **Phase 2: Development**: Invoke `developer-pro` (or `angular-expert` for UI-heavy tasks) to implement the logic according to the requirements, ensuring the code matches modern Angular and Electron standards.
